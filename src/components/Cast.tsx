...
export default function Cast() {
  ...
  return (
    <div className="cast flex flex-col p-10 px-8 ">
      <div className="info flex flex-col gap-10 mid:flex-row mid:items-start items-center">
        <img
          src={
        ...
        <div className="dark:text-white font-roboto px-3 flex flex-col items-start">
          ...
          {actorData?.birthday && (
            <p className="text-2xl my-2 text-gray-600">
              Born: {actorData?.birthday}
            </p>
          )}
          {actorData?.biography ? (
            <p className="my-3 mb-5">
              {actorData?.biography.slice(0, 1300)}...
            </p>
          ) : (
            <p className="text-2xl my-2 mb-5 text-gray-600">No biography exist</p>
          )}
      ...
      <div className="relatedMovies">
        <h1 className="text-3xl text-center uppercase text-semibold mt-10 dark:text-white">
          Related Movies
        </h1>
